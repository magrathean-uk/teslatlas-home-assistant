...
This historical plan was replaced by the [approved concurrent foundation merge design](../specs/2026-08-31-concurrent-foundation-merge-design.md). It is retained only to identify the earlier direction; do not execute it.
```
...
Current authority: [Concurrent Home Assistant foundation merge design](../specs/2026-08-31-concurrent-foundation-merge-design.md).
